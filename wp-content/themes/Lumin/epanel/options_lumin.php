...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#main-area .container #main a, #main-area .container .page-block a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		div#header ul#top-navigation li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		#sidebar h3.title { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		#main-area #sidebar div.widget a { color:#<?php echo(get_option($shortname.'_color_sidebar_links')); ?>; }
		div.footer-widget h4 { color:#<?php echo(get_option($shortname.'_footer_headings')); ?> }
		div.footer-widget a { color:#<?php echo(get_option($shortname.'_color_footerlinks')); ?> }
